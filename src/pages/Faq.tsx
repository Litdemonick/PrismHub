...
const copy = {
  es: {
    ...
    faqs: [
      ...
      {
        q: '¿Es código abierto?',
        a: 'La app es freeware de código cerrado: gratis para usar, pero el código fuente no se publica. Lo que sí es público y abierto (MIT) es prism+, el repositorio de extensiones — la parte que de verdad habla con cada sitio se puede leer entera.',
      },
      {
  ...
  en: {
    ...
    faqs: [
      ...
      {
        q: 'Is it open source?',
        a: "The app is closed-source freeware: free to use, but the source code isn't published. What is public and open (MIT) is prism+, the extensions repository — the part that actually talks to each site can be read in full.",
      },
      {
...
export default function Faq() {
  ...
  const issueUrl = `https://github.com/Litdemonick/PrismHub/issues/new?${new URLSearchParams({
    title: cleanQuery,
    body: lang === 'es'
