...
const copy = {
  es: {
    ...
    contribute: [
      { icon: Bug, title: 'Reportar bugs', desc: 'Abrí un issue en GitHub con los pasos para reproducir el problema.', href: 'https://github.com/Litdemonick/PrismHub/issues' },
      ...
      { icon: GitPullRequest, title: 'Pull requests', desc: 'Mejoras, sitios nuevos o correcciones al catálogo de extensiones son bienvenidas en prism+.', href: 'https://github.com/Litdemonick/prism-plus/pulls' },
  ...
  en: {
    ...
    contribute: [
      { icon: Bug, title: 'Report bugs', desc: 'Open a GitHub issue with steps to reproduce the problem.', href: 'https://github.com/Litdemonick/PrismHub/issues' },
      ...
      { icon: GitPullRequest, title: 'Pull requests', desc: 'Improvements, new sites or fixes to the extensions catalog are welcome on prism+.', href: 'https://github.com/Litdemonick/prism-plus/pulls' },
