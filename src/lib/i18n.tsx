...
export const dict = {
  es: {
    ...
    'hero.badge': 'Freeware · sin anuncios · sin cuentas',
    ...
    'hero.cta.source': 'El proyecto en GitHub',
    ...
    'features.f6.title': 'Extensiones abiertas, sin caja negra',
    'features.f6.desc':
      'prism+, el repositorio oficial de extensiones, es público y MIT: cualquiera puede leer exactamente qué hace cada sitio que instala, o sumar uno propio.',
    ...
    'footer.tagline': 'Anime, manga, novelas, series y películas — sin límites. Gratis, nativo, sin anuncios.',
    'footer.product': 'Producto',
    'footer.install': 'Instalar',
    'footer.project': 'Proyecto',
    'footer.source': 'Proyecto en GitHub',
  ...
  en: {
    ...
    'hero.badge': 'Freeware · no ads · no accounts',
    ...
    'hero.cta.source': 'The project on GitHub',
    ...
    'features.f6.title': 'Open extensions, no black box',
    'features.f6.desc':
      "prism+, the official extensions repository, is public and MIT: anyone can read exactly what each installed site does, or add their own.",
    ...
    'footer.tagline': 'Anime, manga, novels, series and movies — no limits. Free, native, no ads.',
    'footer.product': 'Product',
    'footer.install': 'Install',
    'footer.project': 'Project',
    'footer.source': 'Project on GitHub',
